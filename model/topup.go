...
func Recharge(referenceId string, customerId string, callerIp string) (err error) {
	...
	_ = GrantInviterRewardOnFirstPaidEvent(topUp.UserId, InviteRewardTriggerTopUp, topUp.TradeNo, topUp.PaymentMethod)
...
func ManualCompleteTopUp(tradeNo string, callerIp string) error {
	...
	_ = GrantInviterRewardOnFirstPaidEvent(userId, InviteRewardTriggerAdminManualTopUp, tradeNo, paymentMethod)
	return nil
}
